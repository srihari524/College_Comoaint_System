...
<header> 
 ...
 try {
	...
	Connection con1=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","sri1234");
		...
		out.print("<tr><td><b>USERNAME</b></td><td><b>PASSWORD</b></td>");
		out.print("<td><b>DEPARTMENT</b></td><td><b>REGNO</b></td><td><b>MOBILE</b></td></tr>");
		//4.run the queries  insert query  
		ResultSet rs= st.executeQuery("select * from complaint_student");
		while(rs.next()){
